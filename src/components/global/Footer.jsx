  ...
  return (
    <footer className='bg-purple-700'>
      <div className='px-4 py-16 mx-auto sm:px-4 lg:px-8'>
        ...
        <p className='mt-3 text-center text-white text-sm md:text-xl'>
          Jl. Let. Jend. S. Parman No.1, Blok R Lantai XI, Jakarta 11440
        </p>
        <p className='mt-2 text-center text-white text-sm md:text-xl'>
          Telp :021-.5676260 - 5677949, Fax : 56941924
        </p>
        <p className='mt-2 text-center text-white text-sm md:text-xl'>
          Website :{' '}
          <a href='http://fti.untar.ac.id/'>http://fti.untar.ac.id/</a>
        </p>
